...
## [Dashboard — C2 Fix Wave] — 2026-04-23 (In Progress)

Structured 18-class fix wave driven by C2 audit results (408 cells × 7 pillars). C3 re-run shows 481 improvements and 161 regressions (mobile viewport crashes — open).
...
- **Rail collapse + labels — Class 7** (`a8fb942`) — Rail collapses to icon-only. `dashboard/lib/hooks/use-rail-collapsed.ts`: localStorage-backed, default expanded. Rail and top-bar icons now carry text labels.
