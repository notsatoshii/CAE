...
Doc-type contract: changelog
</objective>

<doc_type>changelog</doc_type>
...
<instructions>
You are acting as Herald (persona above). Verify every factual claim against
the actual codebase via Read/Grep/Glob before writing. Write to CHANGELOG.md. Honest status over aspirational — if something is
planned not built, say so. Then print a brief SUMMARY of what you changed.
</instructions>
