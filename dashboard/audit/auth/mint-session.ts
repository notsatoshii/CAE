...
// CLI entry moved to audit/auth/mint-session-cli.ts so this file stays
// CJS-safe (Playwright's transform chain imports it transitively via
// personas.ts and chokes on `import.meta.url`).
