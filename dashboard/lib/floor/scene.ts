...
export const STATIONS: Readonly<Record<StationName, StationDef>> =
  Object.freeze({
    hub: Object.freeze({ tx: 8, ty: 4, persona: "nexus" as const }),
    forge: Object.freeze({ tx: 4, ty: 3, persona: "forge" as const }),
    watchtower: Object.freeze({ tx: 12, ty: 3, persona: "sentinel" as const }),
    overlook: Object.freeze({ tx: 14, ty: 7, persona: "scout" as const }),
    library: Object.freeze({ tx: 13, ty: 11, persona: "scribe" as const }),
    shadow: Object.freeze({ tx: 8, ty: 13, persona: "phantom" as const }),
    armory: Object.freeze({ tx: 3, ty: 11, persona: "aegis" as const }),
    drafting: Object.freeze({ tx: 2, ty: 7, persona: "arch" as const }),
    pulpit: Object.freeze({ tx: 10, ty: 8, persona: "herald" as const }),
    loadingBay: Object.freeze({ tx: 6, ty: 8, persona: null }),
  });
