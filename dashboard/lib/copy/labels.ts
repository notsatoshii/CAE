...
const FOUNDER: Labels = {
  ...
  workflowsListEmpty: "No saved workflows yet. Describe what you want to automate and CAE will draft it.",
  ...
  workflowsEditPageHeading: (name) => "Workflow: " + name,
  workflowsNlTextareaPlaceholder: "Describe what you want this workflow to do. Example: Every Monday, Forge updates our dependencies, Sentinel reviews, I approve, then push.",
  workflowsNlTextareaLabel: "What should this workflow do?",
  workflowsDraftBtn: "Draft it",
  workflowsDraftBtnPending: "Drafting…",
  workflowsSaveBtn: "Save workflow",
  ...
  workflowsStepGraphHeading: "Here's the workflow",
  ...
  workflowsDeleteBtn: "Delete workflow",
  workflowsDeleteConfirm: (name) => "Delete the '" + name + "' workflow? This can't be undone.",
  ...
  emptyWorkflowsHeading: "No saved workflows yet.",
  emptyWorkflowsBody: "Describe what you want to automate — CAE will draft a workflow.",
  emptyWorkflowsCtaRecipe: "New workflow",

  emptyQueueHeading: "Nothing queued.",
  emptyQueueBody: "CAE's inbox is clear. Send a job or run a workflow.",
  emptyQueueCtaJob: "New job",
  emptyQueueCtaWorkflows: "Open workflows",
